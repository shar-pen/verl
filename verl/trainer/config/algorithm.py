...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        psr_weight (float): Positive-advantage scale used by GRPO-PNSR.
        nsr_weight (float): Negative-advantage scale used by GRPO-PNSR.
    ...
    psr_weight: float = 1.0
    nsr_weight: float = 1.0
