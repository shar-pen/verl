...
exp_name='GRPO-Qwen2.5_MATH_1.5B_EXT-sample16'
...
# Paths
model_path="${RAY_DATA_HOME}/models/Qwen2.5-Math-1.5B-EXT"
ckpts_dir="${RAY_DATA_HOME}/ckpts/${project_name}/${exp_name}"
train_file="${RAY_DATA_HOME}/data/dapo_math_17k/train_deduped.parquet"
test_file="${RAY_DATA_HOME}/data/aime/aime2024.parquet"
